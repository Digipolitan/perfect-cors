# Contributing to perfect-cors-swift
...
* **Did the problem start happening recently** (e.g. after updating to a new version of perfect-cors-swift) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of perfect-cors-swift ?** What's the most recent version in which the problem doesn't happen? You can download older versions of perfect-cors-swift from [the releases page](https://github.com/digipolitan/perfect-cors-swift/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of perfect-cors-swift are you using?
...
#### Template For Submitting Bug Reports
    ...
    **perfect-cors-swift version:** [Enter perfect-cors-swift version here]
    ...
    * Problem started happening recently, didn't happen in an older version of perfect-cors-swift: [Yes/No]
